...
function ClientAddSale (props){

 const url = "/web/sales/add"
                ...
                <form  action="/web/sales/update"  onSubmit = {(e) =>submit(e)} method="HTTP_METHOD" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input onChange = {(e) =>handle(e)} id="barcode" type="text" class="form-control" name="barcode" value={data.barcode}  />
                    </div>
                    <div class="form-group col-6">
                      <label for="">Date Of Barcode</label>
                      <input onChange = {(e) =>handle(e)} id="date_of_barcode" type="text" class="form-control" name="date_of_barcode" value={data.date_of_barcode} />
                    </div>
                  ...
                  <div class="form-group col-6">
                      ...
                      <input onChange = {(e) =>handle(e)} id="tracking_url" type="text" class="form-control" name="tracking_url" value={data.tracking_url} />
                    </div>
                  <div class="form-group col-6">
                      <label for="">Product Item</label>
                      <input onChange = {(e) =>handle(e)}  id="product_item" type="text" class="form-control" name="product_item" value={data.product_item}/>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <input onChange = {(e) =>handle(e)} type="hidden" name="sale_id"  id ="sale_id" value={data.sale_id}  />
                    </div>
                </div>
